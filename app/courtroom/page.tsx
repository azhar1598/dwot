...
export const metadata: Metadata = {
  ...
  description:
    "Type your bureaucratic complaint. Justice Jojo will hear your case — and help you send a real letter to your MP or MLA.",
};
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-10 px-6 py-16 sm:py-24">
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-xl font-mono text-sm leading-relaxed text-muted">
            ...
            Jojo will hear it and rule accordingly — and if it&apos;s a
